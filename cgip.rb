class Cgip < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/divanvisagie/chat-gipity/releases/download/v0.2.4/cgip-darwin-x86_64.tar.gz"
    sha256 "4e56d477eb40af3a851cd52a619db6d5c49f731a4700625a3652169cd84b2ba3"
  elsif Hardware::CPU.arm?
    url "https://github.com/divanvisagie/chat-gipity/releases/download/v0.2.4/cgip-darwin-arm64.tar.gz"
